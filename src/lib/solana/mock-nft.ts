...
export async function mintAgentNFT(agent: ForgeAgent): Promise<MintResult> {
  ...
  const metadata: NFTMetadata = {
    ...
    attributes: [
      ...
      { trait_type: 'Solana Knowledge', value: agent.traits.solanaKnowledge },
      { trait_type: 'Coding Skill', value: agent.traits.codingSkill },
      { trait_type: 'Creativity', value: agent.traits.creativity },
      { trait_type: 'Founder Mindset', value: agent.traits.founderMindset },
